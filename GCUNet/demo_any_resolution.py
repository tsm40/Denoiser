...
import cv2
import argparse
from model.GCNet import GCNet_model
import math
...
parser.add_argument('--input_dir', default='result/datasets/Kodak24_noisy/sigma10/', type=str, help='Input images')
...
parser.add_argument('--result_dir', default='result/denoised/Kodak24/sigma10', type=str, help='Directory for results')
parser.add_argument('--weights',
                    default='checkpoints/Denoising/models/model_bestPSNR.pth', type=str,
